...
import { BackBlack, Mapgrey, MapOrange, PencilOrange, Sort, StarOrange } from '../../assets/svg';
    ...
    <View style={styles.view}>
      ...
      <View style={styles.view4}>
        <View style={styles.view5}>
          ...
          <Text style={styles.text2}> {checkin} to {checkout} | {guest} Guests | {room} Room</Text>
        </View>
        <TouchableOpacity onPress={()=>navigation.navigate("VisiterTimer")}>
          <PencilOrange />
      ...
      <View style={styles.view6}>
        ...
        <Text style={styles.text5}>Price (Low to High)</Text>
      </View>
              ...
              <View style={styles.view7}>
                ...
                <View style={styles.view9}>
                  ...
                  <View style={styles.view8}>
                    ...
                    <Buttons onClick={()=>navigation.navigate("RoomDetail")}
