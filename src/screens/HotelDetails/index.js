    ...
    return (
        <View style={styles.view}>
            ...
            <View style={styles.view3}>
                <ImageBackground style={styles.imgback} source={IMAGES.HOMEDETAILMAIN}>
                    <View style={styles.view1}>
                        ...
                        <View style={styles.view2}>
                            <Text style={styles.text}>Hotel Details</Text>
                        </View>
                    </View>
                </ImageBackground>
            </View>
            ...
            <View style={styles.view4}>
                <View style={styles.view5}>
                    <Text style={styles.text1}>Hotel Niribili</Text>
                ...
                <View style={styles.view5}>
                    ...
                    <Text style={styles.text4}>(For 01 Night/Room)</Text>
                </View>
                ...
                <View style={styles.view7}>
                    ...
                    <Text style={styles.text7}>150 Reviews</Text>
                    <Text style={styles.text6}>)</Text>
                </View>
